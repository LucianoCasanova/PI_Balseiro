...
Foam::tmp<Foam::volVectorField> Foam::functionObjects::wallShearStress::calcShearStress(const volSymmTensorField& tau)
{
    ...
    forAllConstIter(labelHashSet, patchSet_, iter)
    {
        ...
        vectorField miTau = (-Sfp/magSfp) & tau.boundaryField()[patchi]; //tau vector
        ...
        {
            tauTangVec[i].x() = tauTang[i]; // Asigna el valor de tauTang al componente x del vector correspondiente en tauTangVec
        }
